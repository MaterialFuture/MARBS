...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/MaterialFuture/voidrice"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/MaterialFuture/MARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to LARBS\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-MaterialFuture" 10 60
...
systembeepoff() { dialog --infobox "Getting rid of the ThinkPad error beep sound..." 10 50
	rmmod pcspkr
